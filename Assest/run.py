            ...
            try:
                ...
                if apk_file.endswith('.apk'):
                    if os.path.exists(apk_file) == False:
                        ...
                        apk_file_basename = os.path.basename(apk_file)

                        if os.path.exists('Output/'+apk_file_basename):
                            shutil.rmtree('Output/'+apk_file_basename)
                        pass

                        os.mkdir('Output/'+apk_file_basename)
                        os.chdir('Output/'+apk_file_basename)
                        shutil.move(apk_file[:-4] + '_reversed.apk', os.getcwd())


                        f=open(apk_file_basename[:-4] + '_backdoored.rc',"w+") 
                        ...
                        f.close()
                        cls()
                        print('Output file Located in ' + 'Output/' +apk_file_basename[:-4] + '_reversed.apk')
                        raw_input("Press Enter to continue...")
                        cls()
                        pass
